...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_userprofile', 'usertype',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.usertype'
        db.delete_column(u'accounts_userprofile', 'usertype')
