...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.additional_emails'
        db.add_column(u'accounts_userprofile', 'additional_emails',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.additional_emails'
        db.delete_column(u'accounts_userprofile', 'additional_emails')
