...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.years'
        db.add_column(u'events_event', 'years',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.time_created'
        db.add_column(u'events_event', 'time_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.years'
        db.delete_column(u'events_event', 'years')

        # Deleting field 'Event.time_created'
        db.delete_column(u'events_event', 'time_created')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'years': ('django.db.models.fields.CharField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'})
        }
    }
